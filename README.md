...
Soundness Layer is a decentralized verification layer that aims to dramatically reduce on chain costs for verifying Zero Knowledge Proofs (ZKP) 
while ensuring fast finality and censorship resistance.
